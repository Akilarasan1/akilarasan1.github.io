...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const animateElements = document.querySelectorAll('.section-header, .about-text, .about-card, .skill-category, .timeline-item, .project-card, .contact-info, .contact-form');
